...
....
673 starting
673 finished in 283 s
674 starting
674 finished in 303 s
....

where e.g. 673, 674 and 675 refer to the processing of blocks under `+$BITCOIN_DATA_DIR/blocks+`, e.g. `+$BITCOIN_DATA_DIR/blocks/blk00673.dat+`, `+$BITCOIN_DATA_DIR/blocks/blk00674.dat+` and so on, and how long each took to finish in seconds.
